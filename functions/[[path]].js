...
<svg width="512" height="512" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="96" y1="72" x2="416" y2="448" gradientUnits="userSpaceOnUse">
      <stop stop-color="#0C172A"/>
      <stop offset="1" stop-color="#102A46"/>
    </linearGradient>
    <linearGradient id="mist" x1="128" y1="300" x2="384" y2="300" gradientUnits="userSpaceOnUse">
      <stop stop-color="#7CC7FF" stop-opacity="0.95"/>
      <stop offset="1" stop-color="#9CF0DD" stop-opacity="0.95"/>
    </linearGradient>
  </defs>
  <rect x="32" y="32" width="448" height="448" rx="112" fill="url(#bg)"/>
  <path d="M168 268C176 228 210 202 252 202C286 202 314 217 330 243C335 241 341 240 347 240C374 240 396 262 396 289C396 317 374 339 347 339H174C141 339 115 313 115 280C115 252 135 228 162 222C159 236 160 251 168 268Z" fill="#EDF5FF" fill-opacity="0.96"/>
  <path d="M150 336H363" stroke="url(#mist)" stroke-width="14" stroke-linecap="round"/>
  <path d="M174 368H338" stroke="url(#mist)" stroke-width="14" stroke-linecap="round" opacity="0.8"/>
  <path d="M196 400H316" stroke="url(#mist)" stroke-width="14" stroke-linecap="round" opacity="0.62"/>
  <path d="M220 220L202 250" stroke="#9CF0DD" stroke-width="14" stroke-linecap="round"/>
  <path d="M284 212L266 242" stroke="#7CC7FF" stroke-width="14" stroke-linecap="round"/>
  <path d="M332 232L314 262" stroke="#9CF0DD" stroke-width="14" stroke-linecap="round"/>
</svg>`;
...
function isIconRoute(pathname) {
  return pathname === "/favicon.ico" || pathname === "/favicon.svg" || pathname === "/favicon-16x16.png" || pathname === "/favicon-32x32.png" || pathname === "/apple-touch-icon.png";
}
...
function serveManifest() {
  const manifest = {
    ...
    icons: [
      {
        src: `/favicon.svg?${HOME_ICON_VERSION}`,
        sizes: "any",
        type: "image/svg+xml",
      },
      {
